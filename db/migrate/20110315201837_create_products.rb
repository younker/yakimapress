class CreateProducts < ActiveRecord::Migration
  ...
  def self.populate
    Product.create!(:name => 'Wine Press', :descr => self.lorem, :price => 799.99, :permalink => 'wine-press', :meta_description => 'this is the wine press meta desription', :meta_keywords => 'wine,press,wine press,yakima,grapes,get drunk')
    Product.create!(:name => 'American Harvester Cider Mill', :descr => self.cider_press_descr, :price => 999.99, :permalink => 'american-harvester-cider-mill-apple-press', :meta_description => 'The American Harvester is a double tub, hand operated cider mill apple press.', :meta_keywords => 'cider mill, american harvester, double tub, apple press, cider, press, cider press, yakima, apples')
  end
